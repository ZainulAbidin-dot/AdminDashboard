                ...
                <DialogContent>
                    ...
                    >
                        ...
                        <TextField
                            ...
                            value={selectedAccount?.currentEquity}
                            onChange={handleChangeEdit}
                            name="currentEquity"
                            validators={[]}
                            errorMessages={[]}
                        ...
                        <TextField
                            ...
                            margin="dense"
                            label="Drawdown"
                            value={selectedAccount?.currentDrawdown}
                            onChange={handleChangeEdit}
                        ...
                        <TextField
                            ...
                            margin="dense"
                            label="Profit Share"
                            value={selectedAccount?.profitShare}
                            onChange={handleChangeEdit}
                            name="profitShare"
                            validators={[]}
                            errorMessages={[]}
                        ...
                        <FormControl style={{ width: '100%' }}>
                            ...
                            <Select
                                labelId="Allow"
                                value={selectedAccount?.allow ? 'Allow' : 'Prohibit' || ''}
                                onChange={handleChangeEdit}
                                label="Allow"
                            >
                                <MenuItem value=""></MenuItem>
                                <MenuItem value={'Allow'}>Allow</MenuItem>
                                <MenuItem value={'Prohibit'}>Prohibit</MenuItem>
                            </Select>
                        </FormControl>
                        <TextField
                            autoFocus
                            ...
                            margin="dense"
                            label="Block Reason"
                            value={selectedAccount?.blockReason || ''}
                            onChange={handleChangeEdit}
                            name="blockReason"
                            errorMessages={['this field is required']}
                        />
                        <FormControl style={{ width: '100%' }}>
                            ...
                            <Select
                                labelId="Trade System"
                                value={selectedAccount?.tradeSystem || ''}
                                onChange={handleChangeEdit}
                                label="Trade System"
                            >
                                <MenuItem value=""></MenuItem>
